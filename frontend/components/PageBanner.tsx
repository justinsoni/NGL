...
const PageBanner: React.FC<PageBannerProps> = ({ title, subtitle }) => {
  return (
    <div className="w-full h-32 md:h-40 bg-gradient-to-r from-theme-primary via-theme-primary-dark to-theme-accent flex items-center justify-center border-b-2 border-theme-border">
