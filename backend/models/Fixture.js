...
const eventSchema = new mongoose.Schema({
  ...
  type: { type: String, enum: ['goal', 'yellow_card', 'red_card', 'foul', 'corner', 'shot'], required: true },
  ...
  // Generic/shot fields
  description: { type: String, trim: true }, // e.g., 'on_target'
  onTarget: { type: Boolean, default: false }
